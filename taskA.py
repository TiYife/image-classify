...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default='./valid')
    parser.add_argument('--dataset', type=str, default='resnet50', help='ImageNet2012')
    parser.add_argument('--model', type=str, default='resnet50', help='model')
    parser.add_argument('--model-name', type=str,
                        default='./models/resnet50-19c8e357.pth', help='model for test')
