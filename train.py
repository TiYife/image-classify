...
from models.modelB import ResNet
...
train_dataset_dir = './train/'  # the path of your train_dataset
test_dataset_dir = './valid/'  # the path of your test_dataset
...
net = nn.DataParallel(ResNet([3, 4, 6, 3], num_class, img_channel))
